  ...
  <Layout>
    ...
    <CardTitle className="contact-card__title text-center">Thank You!</CardTitle>
          <CardSubtitle className="contact-card__success-subtitle text-center">
            Your message has successfully been sent to kearnsSP@vcu.edu. I appreciate you taking the time to reach out to me and I will be sure to give you a speedy response.
          </CardSubtitle>
          <CardBody>
